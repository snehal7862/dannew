...
if($_POST['template_type'] == "Assessment Delete") {

    $id = $_POST['template_id'];

    $query = "DELETE FROM  assessment_template WHERE id = ?";
    sqlStatement($query, $id);
...
if($_POST['template_type'] == "Procedure Delete") {

    $id = $_POST['template_id'];

    $query = "DELETE FROM  form_treatment_note WHERE id = ?";
    sqlStatement($query, $id);
...
if($_POST['template_type'] == "ICD Code Delete") {

    $id = $_POST['template_id'];

    $query = "DELETE FROM  icd_codes WHERE id = ?";
    sqlStatement($query, $id);
