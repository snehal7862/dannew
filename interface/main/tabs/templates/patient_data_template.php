    ...
    <div class="d-lg-inline-flex w-100">
        <div class="flex-fill">
            ...
            <div class="form-group">
                ...
                ?>
                <a style="color:#058ea5 !important" class="ptName <?php echo $classes ?? ''; ?> " data-bind="click:refreshPatient,with: patient" href="#" title="<?php echo xla("To Dashboard") ?>">
        ...
        <div class="flex-fill ml-2">
            <!-- ko if: patient -->
            <!-- ko with: patient -->
            <div class="btn-group btn-group-sm" style="background-color: rgb(18 157 180);">
                <a class="btn btn-sm btn-secondary" data-bind="click: clickEncounterList" href="#"
                   title="<?php echo xla("Visit History"); ?>">
                    <i class="fas fa-history" style=" border-color: #d1d6dc !important;
    color: rgb(230 240 244 / 97%) !important;"></i>
                </a>
                <div class="btn-group dropdown">
                    <button style=" border-color: #d1d6dc !important;
    color: rgb(230 240 244 / 97%) !important;" class="btn btn-secondary btn-sm dropdown-toggle"
                ...
                <a class="btn btn-sm btn-secondary" data-bind="click: clickNewEncounter" href="#"
                   title="<?php echo xla("New Encounter"); ?>">
                    <i class="fa fa-plus" style=" border-color: #d1d6dc !important;
    color: rgb(230 240 244 / 97%) !important;"></i>
                </a>
            </div>
