...
class CdaTemplateImportDispose
{
    ...
    private function constantDuplicateCheck($pc_const_id)
    {
        file_put_contents('/var/www/traps/constantDuplicateCheck.txt', $pc_const_id . "\n", FILE_APPEND);
        error_log('Constant is ' . $pc_const_id);
        return false;
    }
